(function() {
  ...
  DesktopUploader = function(options) {
    ...
    InnerDesktopUploader = (function(_super) {
      ...
      InnerDesktopUploader.prototype.concurrency = function(value) {
        return queue.concurrency = value;
      };

      InnerDesktopUploader.prototype.throttle = function(bytes) {
        if (bytes) {
      ...
      InnerDesktopUploader.prototype.retry = function(times) {
